...
public class Publisher {
    ...
    public void publish() throws Exception {
        ...
        channel.basicPublish(EXCHANGE_NAME,"samll.white.rabbit",null,"小白兔!".getBytes());
        channel.basicPublish(EXCHANGE_NAME,"lazy.dog.dog",null,"懒狗狗!".getBytes());
